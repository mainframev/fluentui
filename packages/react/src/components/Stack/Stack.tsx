...
function _isStackItem(item: React.ReactNode) {
  ...
  return (
    ...
    ((item as React.ReactElement).type as React.ComponentType<React.PropsWithChildren<unknown>>).displayName ===
...
export const Stack: React.FunctionComponent<React.PropsWithChildren<IStackProps>> & {
