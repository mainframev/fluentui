...
const CustomButton: React.FunctionComponent<React.PropsWithChildren<IButtonProps>> = props => {
...
const CustomMenuItem: React.FunctionComponent<React.PropsWithChildren<IContextualMenuItemProps>> = props => {
...
export const CommandBarButtonAsExample: React.FunctionComponent<React.PropsWithChildren<unknown>> = () => {
  return (
    <CommandBar
