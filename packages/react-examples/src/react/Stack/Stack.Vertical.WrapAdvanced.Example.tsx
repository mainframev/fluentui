...
const VerticalStackWrapAdvancedExampleContent: React.FunctionComponent<React.PropsWithChildren<IExampleOptions>> = props => {
...
export const VerticalStackWrapAdvancedExample: React.FunctionComponent<React.PropsWithChildren<unknown>> = () => {
